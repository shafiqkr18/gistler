...
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css">
  ...
  <script src="{{URL::asset('public/js/magicsuggest7.js')}}"></script>
...
<nav class="nav-top headerstyle2">
				...
				<div class="scroller-spy">
					<div class="bottomnavigation">
						...
						<ul id="menu2">
							...
							<li><a href="#" class="drop">All Specialities &nbsp; </a>
								<div class="dropdown_1column align_right">
										...
										<div class="col_1">
											...
											<ul class="simple ">
												<li><input type="checkbox" id="sec2property2" onclick="active_reset()" name="propertytype[]" value="1"> <label for="sec2property2">Apartment (100)</label></li>
												<li><input type="checkbox" id="sec2property3" onclick="active_reset()" name="propertytype[]" value="2"> <label for="sec2property3">Duplex (100)</label></li>
												<li><input type="checkbox" id="sec2property4" onclick="active_reset()" name="propertytype[]" value="3"> <label for="sec2property4">Land Plot (100)</label></li>
												<li><input type="checkbox" id="sec2property6" onclick="active_reset()" name="propertytype[]" value="4"> <label for="sec2property6">Office (100)</label></li>
												<li><input type="checkbox" id="sec2property7" onclick="active_reset()" name="propertytype[]" value="5"> <label for="sec2property7">Penthouse (100)</label></li>
												<li><input type="checkbox" id="sec2property8" onclick="active_reset()" name="propertytype[]" value="6"> <label for="sec2property8">Retails Space (100)</label></li>
												
												<li><input type="checkbox" id="sec2property9" onclick="active_reset()" name="propertytype[]" value="7"> <label for="sec2property9">Villa/House (100)</label></li>
												<li><input type="checkbox" id="sec2property10" onclick="active_reset()" name="propertytype[]" value="8"> <label for="sec2property10">Townhouse (100)</label></li>
												<li><input type="checkbox" id="sec2property11" onclick="active_reset()" name="propertytype[]" value="9"> <label for="sec2property11">Warehouse (100)</label></li>
												<li><input type="checkbox" id="sec2property12" onclick="active_reset()" name="propertytype[]" value="10"> <label for="sec2property12">Buildings (100)</label></li>
							...
							<li><a href="#" class="drop">All Agents &nbsp; </a>
								<div class="dropdown_1column align_right">
								 
										<div class="col_1">
											
											<ul class="simple ">
												<li><input type="checkbox" id="sec3property2" onclick="active_reset()" name="propertytype[]" value="1"> <label for="sec3property2">Apartment (100)</label></li>
												<li><input type="checkbox" id="sec3property3" onclick="active_reset()" name="propertytype[]" value="2"> <label for="sec3property3">Duplex (100)</label></li>
												<li><input type="checkbox" id="sec3property4" onclick="active_reset()" name="propertytype[]" value="3"> <label for="sec3property4">Land Plot (100)</label></li>
												<li><input type="checkbox" id="sec3property6" onclick="active_reset()" name="propertytype[]" value="4"> <label for="sec3property6">Office (100)</label></li>
												<li><input type="checkbox" id="sec3property7" onclick="active_reset()" name="propertytype[]" value="5"> <label for="sec3property7">Penthouse (100)</label></li>
												<li><input type="checkbox" id="sec3property8" onclick="active_reset()" name="propertytype[]" value="6"> <label for="sec3property8">Retails Space (100)</label></li>
												
												<li><input type="checkbox" id="sec3property9" onclick="active_reset()" name="propertytype[]" value="7"> <label for="sec3property9">Villa/House (100)</label></li>
												<li><input type="checkbox" id="sec3property10" onclick="active_reset()" name="propertytype[]" value="8"> <label for="sec3property10">Townhouse (100)</label></li>
												<li><input type="checkbox" id="sec3property11" onclick="active_reset()" name="propertytype[]" value="9"> <label for="sec3property11">Warehouse (100)</label></li>
												<li><input type="checkbox" id="sec3property12" onclick="active_reset()" name="propertytype[]" value="10"> <label for="sec3property12">Buildings (100)</label></li>
							...
							<li><a>100 Real Estate Agents</a></li>
 ...
 <div class="bg-wraper parallax-point-event">
  ...
  <!--side bar here-->
		...
		@include('layouts.sidebar_agentsmap')	
