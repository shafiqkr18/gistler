...
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css">
  ...
  <script src="{{URL::asset('public/js/jquery.mCustomScrollbar.concat.min.js')}}"></script>
   ...
   <script src="//code.jquery.com/ui/1.11.4/jquery-ui.js"></script>
    ...
    <script src="{{URL::asset('public/js/woco.accordion.min.js')}}"></script>
        <link href="{{URL::asset('public/css/woco-accordion.min.css')}}" rel="stylesheet">
