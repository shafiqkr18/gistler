<ul class="floatingside listside2 list-bottom" id="fixedscroll">
				<li><a href="#"><img src="{{URL::asset('public/images/icon-file.png')}}"></a>
				...
				<li><a href="homeservices_map.php"><img src="{{URL::asset('public/images/side-icon1.png')}}"></a>
				...
				<li><a href="#"><img src="{{URL::asset('public/images/side-icon2.png')}}"></a>
					<ul class="mainlength3">
						<li>
							<div class="sectionslide">
				...
				<li>
					<a href="#"><img src="{{URL::asset('public/images/side-icon3.png')}}"></a>
					<ul class="mainlength3">
						<li>
							<div class="sectionslide">
				...
				<li><a href="#"><img src="{{URL::asset('public/images/side-icon6.png')}}"></a>
					<ul class="mainlength3">
						<li>
							<div class="sectionslide">
				...
				<li><a href="#"><img src="{{URL::asset('public/images/side-icon8.png')}}"></a>
