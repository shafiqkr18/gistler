<ul class="floatingside listside2 list-bottom" id="fixedscroll">
				<li><a href="{{ url('/homeservices-list') }}"><img src="{{URL::asset('public/images/blockview.png')}}"></a>
					<ul class="mainlength3">
						<li>
							<div class="sectionslide">
								<p><a href="{{ url('/homeservices-list') }}">Grid View</a></p>
							</div>
						</li>
					</ul>
				</li>
				<li><a href="#"><img src="{{URL::asset('public/images/gist_button.png')}}"></a>
					<ul class="mainlength3">
						<li>
							<div class="sectionslide">
								<p><a href="#">Gist View</a></p>
							</div>
						</li>
					</ul>
				</li>
